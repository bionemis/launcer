internal class co
{
	...
	public const int lb = 57;

	public const int lc = 85;

	public const int ld = 183;

	public const int le = 7;

	public const int lf = 174;

	public const int lg = 199;

	public const int lh = 160;

	public const int li = 22;

	public const int lj = 66;

	public const int lk = 119;

	public const int ll = 10;

	public const int lm = 193;

	public const int ln = 222;

	public const int lo = 11;

	public const int lp = 24;

	public const int lq = 67;

	public const int lr = 58;

	public const int ls = 53;

	public const int lt = 161;

	public const int lu = 230;

	public const int lv = 60;

	public const int lw = 159;

	public const int lx = 20;

	public const int ly = 109;

	public const int lz = 111;

	public const int ma = 142;

	public const int mb = 170;

	public const int mc = 120;

	public const int md = 173;

	public const int me = 266;

	public const int mf = 82;

	public const int mg = 221;

	public const int mh = 129;

	public const int mi = 23;

	public const int mj = 16;

	public const int mk = 303;

	public const int ml = 55;

	public const int mm = 145;

	public const int mn = 144;

	public const int mo = 130;

	public const int mp = 267;

	public const int mq = 157;

	public const int mr = 107;

	public const int ms = 112;

	public const int mt = 302;

	public const int mu = 108;

	public const int mv = 52;

	public const int mw = 196;

	public const int mx = 276;

	public const int my = 255;

	public const int mz = 277;

	public const int na = 275;

	public const int nb = 282;

	public const int nc = 203;

	public const int nd = 101;

	public const int ne = 217;

	public const int nf = 218;

	public const int ng = 216;

	public const int nh = 192;

	public const int ni = 83;

	public const int nj = 350;

	public const int nk = 352;

	public const int nl = 351;

	public const int nm = 220;

	public const int nn = 80;

	public const int no = 2;

	public const int np = 223;

	public const int nq = 206;

	public const int nr = 224;

	public const int ns = 31;

	public const int nt = 39;

	public const int nu = 38;

	public const int nv = 308;

	public const int nw = 304;

	public const int nx = 202;

	public const int ny = 122;

	public const int nz = 12;

	public const int oa = 487;

	public const int ob = 104;

	public const int oc = 9;

	public const int od = 117;

	public const int oe = 13;

	public const int of = 15;

	public const int og = 278;

	public const int oh = 254;

	public const int oi = 151;

	public const int oj = 191;

	public const int ok = 186;

	public const int ol = 1;

	public const int om = 6;

	public const int on = 124;

	public const int oo = 153;

	public const int op = 307;

	public const int oq = 195;

	public const int or = 190;

	public const int os = 123;

	public const int ot = 301;

	public const int ou = 182;

	public const int ov = 87;

	public const int ow = 86;

	public const int ox = 198;

	public const int oy = 180;

	public const int oz = 209;

	public const int pa = 189;

	public const int pb = 188;

	public const int pc = 114;

	public const int pd = 118;

	public const int pe = 197;

	public const int pf = 147;

	public const int pg = 133;

	public const int ph = 134;

	public const int pi = 146;

	public const int pj = 149;

	public const int pk = 135;

	public const int pl = 194;

	public const int pm = 138;

	public const int pn = 140;

	public const int po = 154;

	public const int pp = 167;

	public const int pq = 33;

	public const int pr = 212;

	public const int ps = 353;

	public const int pt = 164;

	public const int pu = 208;

	public const int pv = 126;

	public const int pw = 234;

	public const int px = 317;

	public const int py = 131;

	public const int pz = 215;

	public const int qa = 88;

	public const int qb = 64;

	public const int qc = 65;

	public const int qd = 54;

	public const int qe = 232;

	public const int qf = 18;

	public const int qg = 259;

	public const int qh = 113;

	public const int qi = 89;

	public const int qj = 205;

	public const int qk = 62;

	public const int ql = 125;

	public const int qm = 26;

	public const int qn = 8;

	public const int qo = 136;

	public const int qp = 158;

	public const int qq = 288;

	public const int qr = 21;

	public const int qs = 17;

	public const int qt = 137;

	public const int qu = 50;

	public const int qv = 309;

	public const int qw = 110;

	public const int qx = 300;

	public const int qy = 28;

	public const int qz = 84;

	public const int ra = 14;

	public const int rb = 299;

	public const int rc = 148;

	public const int rd = 3;

	public const int re = 231;

	public const int rf = 229;

	public const int rg = 233;

	public const int rh = 63;

	public const int ri = 61;

	public const int rj = 127;

	public const int rk = 402;

	public const int rl = 403;

	public const int rm = 30;

	public const int rn = 72;

	public const int ro = 201;

	public const int rp = 51;

	public const int rq = 71;

	public const int rr = 207;

	public const int rs = 200;

	public const int rt = 143;

	public const int ru = 318;

	public const int rv = 27;

	public const int rw = 306;

	public const int rx = 132;

	public const int ry = 25;

	public const int rz = 102;

	public const int sa = 187;

	public const int sb = 105;

	public const int sc = 121;

	public const int sd = 106;

	public const int se = 36;

	public const int sf = 70;

	public const int sg = 32;

	public const int sh = 305;

	public const int si = 162;

	public const int sj = 156;

	public const int sk = 141;

	public const int sl = 139;

	public const int sm = 0;

	public const int sn = 150;

	public const int so = 210;

	public const int sp = 400;

	public const int sq = 401;

	public const int sr = 56;

	public const int ss = 214;

	public const int st = 152;

	public const int su = 68;

	public const int sv = 4;

	public const int sw = 298;

	public const int sx = 103;

	public const int sy = 100;

	public const int sz = 69;

	public const int ta = 155;

	public const int tb = 59;

	public const int tc = 240;

	public const int td = 226;

	public const int te = 225;

	public const int tf = 128;

	public const int tg = 29;

	public const int th = 19;

	public const int ti = 34;

	public const int tj = 258;

	public static string zk(int a)
	{
		switch (a)
		{
		case 0:
			return "操作无法正确的完成。The operation completed successfully.";
		case 1:
			return "不正确的方法。Incorrect function.";
		case 10:
			return "环境是不正确的。The environment is incorrect.";
		case 100:
		...
		case 111:
			return "文件名太长。The file name is too long.";
		case 112:
		...
		case 16:
			return "目录无法移除。The directory cannot be removed.";
		case 160:
			return "一个或多个参数不正确。One or more arguments are not correct.";
		case 161:
			return "指定的路径无效。The specified path is invalid.";
		case 162:
		...
		case 199:
			return "The operating system cannot run this application program.";
		case 2:
			return "系统无法找到指定的文件。The system cannot find the file specified.";
		case 20:
			return "系统无法找到知道的设备。The system cannot find the device specified.";
		case 200:
